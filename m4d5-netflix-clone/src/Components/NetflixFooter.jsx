...
const NetflixFooter = () => {
    return (
        ...
        <div className="row mt-5">
            ...
            <FontAwesomeIcon id="footerIcon" icon={["fab",  "fa-facebook-square"]} />

            <button type="button" className="mybutton btn btn-secondary">
                <svg
        ...
        <div className="row col-6 offset-3">
            <div className="col-6 col-sm-3 col-md-4 col-lg-3 mt-5">
            <button type="button" className="serviceButton btn btn-secondary">Service Code</button>
